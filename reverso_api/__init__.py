...
"""This is the API developed by Demian Wolf. I simplified it a bit for sake of this add-on. I didn't include the voice API. Perhaps, it can be included in a future version of the add-on"""
"""Please, refer to the original code of the API here: https://github.com/demian-wolf/ReversoAPI"""
    ...
    def get_examples(self):
        ...
        for npage in range(1, self.page_count + 1):
            ...
            for word in examples_json:
                source = BeautifulSoup(word["s_text"], features="html.parser")  # Siasio: changed from lxml to html.parser
                target = BeautifulSoup(word["t_text"], features="html.parser")
